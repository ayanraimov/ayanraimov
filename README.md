...
Estudiante de **Desarrollo de Aplicaciones Web (DAW)** en FP Dual Intensiva, especializado en **backend development**. Apasionado por crear aplicaciones robustas y escalables. Busco prácticas para aplicar mis conocimientos en un entorno profesional y seguir creciendo como desarrollador.

- 💻 Trabajando en proyectos personales con **NestJS, TypeScript y Prisma**
- 🎓 Formación: Java, Python, SQL, APIs REST
